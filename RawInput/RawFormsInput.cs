...
namespace RawInput
{
    class RawFormsInput : RawInput
    {
        ...
        public RawFormsInput(IntPtr parentHandle, RawInputCaptureMode captureMode) : base(parentHandle, captureMode)
        {
            _window = new RawInputNativeWindow(this, parentHandle);
        }

        public RawFormsInput(IWin32Window window, RawInputCaptureMode captureMode) : this(window.Handle, captureMode)
        {
        }
