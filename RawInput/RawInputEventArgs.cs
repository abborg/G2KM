...
namespace RawInput
{
    ...
    public sealed class RawInputMouseEventArgs : EventArgs
    {
        ...
        public ushort ButtonData { get; private set; }
        public long LastX { get; private set; }
        public long LastY { get; private set; }
        public bool Handled { get; set; }
        
        internal RawInputMouseEventArgs(RawMouseDevice device, ushort flags, ushort buttonFlags, ushort buttonData, int lastX, int lastY)
        {
            Device = device;
            Flags = flags;
